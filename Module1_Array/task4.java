class Main {
    public static void main(String[] args) {
        ...
        System.out.println(" ________After append: ______");
       ...
       System.out.println(" current size is "+ cz);
        ...
        System.out.println(" ________After pop: ______");
       ...
       System.out.println(" current size is "+ cz);
        ...
        System.out.println(" ________After Insertion: ______");
       ...
       System.out.println(" current size is "+ cz);
        ...
        System.out.println(" ________After Deletion: ______");
